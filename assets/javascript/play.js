...
function generateQuestion() {
  ...
  for (let i = 0; i < totalQuestions.length; i++) {
    ...
    if (questionsLeft < 5) {
      ...
      // putting score value in local storage with the name 'mostRecentScore'
      localStorage.setItem("mostRecentScore", score);
      // using the assign method in conjuction with window.location to return to a results page
      return window.location.assign("../results/results-page.html");
    }
  }
}
